...
<header class="bg-indigo-600 shadow py-4 px-6">
    <div class="max-w-full mx-auto flex justify-between items-center space-x-32">
        ...
        <!-- Right: Profile + Icons -->
        <div class="flex items-center space-x-4 flex-col items-end">
            <div class="flex items-center space-x-4">
                ...
                <a href="{{ route('notifications') }}" id="notification-icon" class="icon-link border border-white text-white px-4 py-2 rounded-md hover:bg-indigo-100 hover:text-indigo-700 transition relative" title="Notifications">
                    <i class="fas fa-bell text-lg"></i>
                    <span id="notification-badge" class="absolute top-0 right-0 inline-block w-3 h-3 bg-red-600 rounded-full hidden"></span>
                </a>
            </div>
            <div class="header-buttons-container mt-2 flex flex-col gap-2 w-full max-w-xs">
